/**
 * @(#)SeaWater.java	1.0 2014.07.21
 * 
 * Modified from official GeoTools repository: http://geotools.org/
 * Copyright 2007 MiniUFO, All rights reserved.
 * MiniUFO Studio. Use is subject to license terms.
 */
package miniufo.geophysics.ocean;
...
public final class SeaWater2{
     ...
     */
    static final double C3515 = 42.9140;
     ...
     */
    static final double MS = 0.0314038218;
     ...
     */
    static final double CP0 = 3991.86795711963;
     ...
     */
    static final double SSO = 35.16504;
    
    /**
     * The molar gas constant = 8.314472 m :sup:`2` kg s:sup:`-21 K :sup:`-1`
     * mol :sup:`-1`.
     */
    static final double R = 8.314472;
     ...
     * 5 below Eqn. (5.5).
     */
    static final double SON_CL = 1.80655;
    
    /**
     * Absolute Pressure of one standard atmosphere in Pa, 101325 Pa.
     */
    static final double P0 = 101325.0;
     ...
     * See Eqn. (5.3)
     */
    static final double ATOMIC_WEIGHT = 31.4038218;
     ...
     * See Eqn. (5.9).
     */
    static final double VALENCE_FACTOR = 1.2452898;
     ...
     * @return density (kg/liter)
     */
    public static double density(double S, double T){ return density(S, T, 0);}
    ...
    public static void main(String[] args){
    	System.out.println(density(34.125,20.14));
    	System.out.println(density(34.125,20.14));
    	System.out.println(density(33.125,18.14));
    }
}
