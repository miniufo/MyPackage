...
public final class Projector{
	...
	public void setProjectionArea(Rectangle r){
		...
		transf_x=center_x+_2D_trans_x;
		transf_y=center_y+_2D_trans_y;
	}
	 ...
	 */
	public float getXScaling(){ return scale_x;}
	 ...
	 * @return the scaling factor
	 */
	public float getYScaling(){ return scale_y;}
	 ...
	 * @return the scaling factor
	 */
	public float getZScaling(){ return scale_z;}
	 ...
	 * @return the scaling factor
	 */
	public float get2DScaling(){ return _2D_scale;}
	 ...
	 */
	public int get2D_xTranslation(){ return _2D_trans_x;}
	 ...
	 */
	public int get2D_yTranslation(){ return _2D_trans_y;}
	 ...
	 */
	public float getElevationAngle(){ return elevation;}
	 ...
	 */
	public float getSinElevationAngle(){ return sin_elevation;}
	 ...
	 */
	public float getRotationAngle(){ return rotation;}
	 ...
	 */
	public float getSinRotationAngle(){ return sin_rotation;}
	 ...
	 */
	public float getCosRotationAngle(){ return cos_rotation;}
	 ...
	 */
	public float getCosElevationAngle(){ return cos_elevation;}
	...
	public Point project(float x,float y,float z){
		...
		float tmp = x; 
		x =  x * sx_cos + y * sy_sin;
		y = tmp* sx_sin + y * sy_cos;
		
		// elevates and projects
		tmp = factor / (y * cos_elevation - z * sz_sin + distance);
		
		return new Point(
			(int)(Math.round(x * tmp) + transf_x),
			(int)(Math.round((y*sin_elevation+z*sz_cos)*-tmp)+transf_y)
		);
	}
}
